...
/**
 * 所属类别: <br/> 用途: <br/> Author:<a href="mailto:hxfein@126.com">黄飞</a> <br/>
 * Date: 2011-1-9 <br/> Time: 下午09:58:24 <br/> Version: 1.0.2 <br/>
 */
public class BatchRowListElement extends Element {
	/**
	 * 单元格关键字
	 */
